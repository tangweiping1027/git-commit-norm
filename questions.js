    ...
    var questions = [
      ...
      },
      {
        ...
        message: function(answers) {
          return entry[answers.type].scope
            ? entry[answers.type].scope.message
            : message.scope
        },
      ...
      },
      {
        ...
        message: function(answers) {
          return entry[answers.type].subject
            ? entry[answers.type].subject.message
            : message.subject
        },
      ...
      },
      {
        ...
        message: function(answers) {
          return entry[answers.type].body
            ? entry[answers.type].body.message
            : message.body
        },
        when: function(answers) {
          return entry[answers.type].body
      ...
      },
      {
        ...
        message: function(answers) {
          return entry[answers.type].breaking
            ? entry[answers.type].breaking.message
            : message.breaking
        },
        when: function(answers) {
          if (
      ...
      },
      {
        ...
        name: "footer",
        message: function(answers) {
          return entry[answers.type].footer
            ? entry[answers.type].footer.message
            : message.footer
        },
        when: function(answers) {
